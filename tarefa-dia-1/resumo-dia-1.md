...
De volta ao terminal, exiba as primeiras 5 linhas do texto do conteúdo do arquivo resumo-dia-1.md (dica: o comando head exibe mais do que as primeiras 5 linhas do texto. Pesquise no Google o termo comando head e veja como mostrar uma quantidade de linhas específica).

Agora tente exibir todas as linhas que tem a palavra programação no texto.

Desafio opcional: exiba todas as linhas que começam com '-'. Em seguida, exiba todas as linhas que não começam com '-'. Pesquise no google sobre o comando grep para conseguir resolver esse desafio.

Execute o comando pwd no diretório onde se encontra o arquivo resumo-dia-1.md.